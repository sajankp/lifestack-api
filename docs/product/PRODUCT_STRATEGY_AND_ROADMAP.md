...
| Voice/capture | WebRTC-grade production transport, broader capture domains, multi-item capture, AI-assisted routing, and ADK migration planning. | Capture is useful as an input layer; Google ADK evaluation and voice-first migration guide is documented in [ADK-EVALUATION-AND-MIGRATION-GUIDE.md](file:///root/projects/lifestack/docs/ADK-EVALUATION-AND-MIGRATION-GUIDE.md) for Phase 2. |
