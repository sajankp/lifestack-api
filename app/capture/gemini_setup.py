                ...
                "parts": [
                    {
                        "text": (
                            ...
                            "When one utterance reports several expense items, log each item as its "
                            "own `log_spending_transaction` call — including identical items: 'two "
                            "bus tickets, 30 each' means TWO separate calls of 30, never one. Do not "
                            "merge, sum, or de-duplicate items the user listed. "
