...
- Multi-workspace consolidated export.
...
- `file_path` nullable string (stage 1 local storage)
...
- Module services/repositories provide normalized row iterators for export building.
- Stage 1 can generate artifacts synchronously for small datasets.
