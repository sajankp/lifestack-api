...
## Open Questions
- Should we add database-level guardrails (for example, DB role permissions or trigger protections) for append-only enforcement in this iteration, or keep it at application-level enforcement for Stage 1?
