...
| [Spec 075: Currency Display Consistency](./spec-075-currency-display-consistency.md) | Implemented | Display profile (locale/grouping), as-of historical FX replay with rate provenance on converted values. |
| [Spec 076: Weekly Summaries Enhancements](./spec-076-weekly-summaries-enhancements.md) | Implemented (api#177, web#126) | Per-workspace cadence, versioned regeneration (no re-notify), dividend/net-worth/return sections. |
| [Spec 077: Custom Financial KPIs](./spec-077-custom-financial-kpis.md) | Implemented | User-defined KPIs from predefined metric types; guardrails-cadence evaluation; expression language fenced off. |
| [Spec 078: Wallet Ledger Reconciliation](./spec-078-wallet-ledger-reconciliation.md) | Implemented | Bank-statement matching as metadata-only links; reconciliation view; transfer timeline deferred as a fast-follow. |
| [Spec 079: Voice/Capture Production Hardening](./spec-079-voice-capture-production-hardening.md) | In progress (Stages A+B implemented) | Measure-first eval gate and WS transport resilience; Stage C and removal of the experimental label remain gated at ≥90%. |
| [Spec 083: Security Identity & Reference Data](./spec-083-security-identity-and-reference-data.md) | Implemented (api PR #175, web PR #123) | Company identity by ISIN→ticker→normalized-name (fixes look-through fragmentation); editable instrument identifiers; identifier mandate on constituents; bundled reference data (AMFI+NSE+Nasdaq Trader) + API-fallback cache; self-documenting CSV template; merge_company_identities backfill CLI. UI: Holdings tab Edit modal (primary correction surface), Analytics Edit Instrument modal, Seed Constituents structured form, Import preview identifier_status badge. |
| [Spec 084: Recurring Transaction Account](./spec-084-recurring-transaction-account.md) | Implemented (api#179, web#128) | Account resolution and validation for recurring transactions and generated occurrences. |
| [Spec 085: Weekly Summary Analytics Reconciliation](./spec-085-weekly-summary-analytics-status-reconciliation.md) | Implemented | Corrected coverage/status reconciliation for weekly summaries and analytics. |
| [Spec 086: Import-Revert Snapshot Integrity](./spec-086-import-revert-snapshot-integrity.md) | Implemented (API + Web) | Snapshot invalidation and visible post-snapshot data-revision provenance. |
| [Spec 087: Redis Dashboard/Net-Worth Cache](./spec-087-redis-dashboard-networth-cache.md) | Implemented, disabled by default | Fail-open TTL response cache for dashboard summary and net worth. |
| [Spec 088: Job Failure Visibility & Alerting](./spec-088-job-retry-dead-letter.md) | Implemented | In-process retry, failure ledger, owner digest, and heartbeat alerting. |
| [Spec 089: Deterministic IST-Morning Schedule](./spec-089-daily-job-schedule-ist-morning.md) | Implemented | Fixed UTC schedule and dependency ordering for daily jobs. |
